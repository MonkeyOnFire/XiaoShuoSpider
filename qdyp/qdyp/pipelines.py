...
class ToMysqlTwistedPipeline(object):
    ...
    def insert_into(self, cursor, item):
        ...
        sql = r"INSERT INTO qdyp VALUES ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}') ON DUPLICATE KEY UPDATE id='{}',upDateTime='{}'".format(id,item['bid'],item['bName'],item['bAuth'],item['desc'],item['cat'],item['catId'],item['cnt'],item['rankCnt'],item['rankNum'],updateTime,item['subCat'],item['subCatId'],id,updateTime)
        #print(sql)
        cursor.execute(sql)
