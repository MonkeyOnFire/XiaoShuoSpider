...
class QdypSpider(scrapy.Spider):
    ...
    start_urls = 'https://m.qidian.com/majax/rank/yuepiaolist?_csrfToken=mkbjTwIxJulb7LioY44UTPUVk2yWWCYoD0HNSykr&gender=male&pageNum={pageNum}&catId=-1&yearmonth=202106/'
    start_page = 1
    end_page = 200
