...
class QdypSpider(scrapy.Spider):
    ...
    start_urls = 'https://m.qidian.com/majax/rank/yuepiaolist?_csrfToken=OSEDHyZKH6C89IXTApimdbSiQAC0wZUIAnOLnW7N&gender=male&pageNum={pageNum}&catId=-1&yearmonth=202106/'
    start_page = 1
    end_page = 200
